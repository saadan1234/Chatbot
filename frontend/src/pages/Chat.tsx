  ...
  return (
   <Box sx={{display: 'flex', flex:1, width:'100%', height:'100%',  gap:3}}>
    <Box sx={{display:{md:"flex", xs:"none", sm:"none"}, flex: 0.2, flexDirection: "column"}}>
      <Box sx={{display: "flex", width:"100%", height: "95vh", bgcolor: "#333333", borderRadius:3,  flexDirection: "column", mx :3, my:3}}>
        ...
        <Button onClick={handleDeleteChats} sx={{width: "200px", color: "black", my:5,fontWight: "700", borderRadius: 3, mx: "auto", bgcolor: "white", ":hover": { bgcolor: "#808080"}}}>
        Clear Conversation
        </Button>
          
      </Box>
    </Box>
    <Box sx={{display: "flex", flex: {md: 0.8, xs: 1, sm: 1}, flexDirection: "column", borderRadius: 3, p: 3, m:4, bgcolor:"#333333"}}>
